...
# Launching ApacheDS
java $JAVA_OPTS $DEF_CTRLS $EXT_CTRLS $DEF_EXT_OP_REQ $DEF_EXT_OP_RESP -Dlog4j.configuration=file:$OPENSHIFT_DATA_DIR/instances/$ADS_INSTANCE_NAME/conf/log4j.properties -Dapacheds.log.dir=$OPENSHIFT_DATA_DIR/instances/$ADS_INSTANCE_NAME/log -cp $ADS_CP org.apache.directory.server.UberjarMain $OPENSHIFT_DATA_DIR/instances/$ADS_INSTANCE_NAME