...
\label{sec:komponenty}
	...
	\subsection{Uwierzytelnianie klientów usług webowych przy użyciu asercji SAML w architekturze SOA}
		...
		Do architektury proponowanego systemu wprowadzono dodatkową warstwę - magistralę usług(ESB). Magistrala usług pośredniczy w wywołaniach usług udostępnianych serwisów.
